...
. Click menu:Administration[Wallboard Configuration] in the side menu.
. Or, click menu:Administration[Configure OpenNMS] in the side menu, then under *Additional Tools*, click *Ops Board Configuration*.
