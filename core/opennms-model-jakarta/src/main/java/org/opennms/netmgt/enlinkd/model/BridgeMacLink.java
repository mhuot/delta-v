...
import org.opennms.netmgt.enlinkd.model.converter.BridgeMacLinkTypeConverter;
...
public class BridgeMacLink implements Serializable {
    ...
    public enum BridgeMacLinkType {
        ...
        BridgeMacLinkType(int type) { m_type = type; }
        protected static final Map<Integer, String> s_typeMap = new HashMap<>();
        static { s_typeMap.put(1, "bridge-link"); s_typeMap.put(2, "bridge-forwarder"); }
        ...
        public static BridgeMacLinkType get(Integer code) {
            if (code == null) throw new IllegalArgumentException("Cannot create BridgeMacLinkType from null code");
            switch (code) { case 1: return BRIDGE_LINK; case 2: return BRIDGE_FORWARDER;
                default: throw new IllegalArgumentException("Cannot create BridgeMacLinkType from code " + code); }
        }
    }
