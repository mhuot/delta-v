...
import org.opennms.netmgt.enlinkd.model.converter.BridgeDot1dBaseTypeConverter;
import org.opennms.netmgt.enlinkd.model.converter.BridgeDot1dStpProtocolSpecificationConverter;
...
public class BridgeElement implements Serializable {
    ...
    public enum BridgeDot1dStpProtocolSpecification {
        DOT1D_STP_PROTOCOL_SPECIFICATION_UNKNOWN(1), DOT1D_STP_PROTOCOL_SPECIFICATION_DECLB100(2),
        DOT1D_STP_PROTOCOL_SPECIFICATION_IEEE8021D(3), DOT1D_STP_PROTOCOL_SPECIFICATION_IEEE8021M(4),
        DOT1D_STP_PROTOCOL_SPECIFICATION_IEEE8021AQ(5);
        private final int m_type;
        BridgeDot1dStpProtocolSpecification(int type) { m_type = type; }
        protected static final Map<Integer, String> TYPE_MAP = new HashMap<>();
        static { TYPE_MAP.put(1, "unknown"); TYPE_MAP.put(2, "decLb100"); TYPE_MAP.put(3, "ieee802.1d"); TYPE_MAP.put(4, "ieee802.1m"); TYPE_MAP.put(5, "ieee802.1aq"); }
        public static String getTypeString(Integer code) { if (TYPE_MAP.containsKey(code)) return TYPE_MAP.get(code); return "other-vendor-specific"; }
        public Integer getValue() { return m_type; }
        public static BridgeDot1dStpProtocolSpecification get(Integer code) {
            if (code == null) throw new IllegalArgumentException("Cannot create Dot1dStpProtocolSpecification from null code");
            if (code <= 0) throw new IllegalArgumentException("Cannot create Dot1dStpProtocolSpecification from" + code + " code");
            switch (code) {
                case 1: return DOT1D_STP_PROTOCOL_SPECIFICATION_UNKNOWN; case 2: return DOT1D_STP_PROTOCOL_SPECIFICATION_DECLB100;
                case 3: return DOT1D_STP_PROTOCOL_SPECIFICATION_IEEE8021D; case 4: return DOT1D_STP_PROTOCOL_SPECIFICATION_IEEE8021M;
                case 5: return DOT1D_STP_PROTOCOL_SPECIFICATION_IEEE8021AQ;
                default: throw new IllegalArgumentException("Cannot create Dot1dStpProtocolSpecification from" + code + " code");
            }
        }
    }

    public enum BridgeDot1dBaseType {
        DOT1DBASETYPE_UNKNOWN(1), DOT1DBASETYPE_TRANSPARENT_ONLY(2), DOT1DBASETYPE_SOURCEROUTE_ONLY(3), DOT1DBASETYPE_SRT(4);
        private final int m_type;
        BridgeDot1dBaseType(int type) { m_type = type; }
        protected static final Map<Integer, String> s_typeMap = new HashMap<>();
        static { s_typeMap.put(1, "unknown"); s_typeMap.put(2, "transparent-only"); s_typeMap.put(3, "sourceroute-only"); s_typeMap.put(4, "srt"); }
        ...
        public static BridgeDot1dBaseType get(Integer code) {
            if (code == null) throw new IllegalArgumentException("Cannot create Dot1dBaseType from null code");
            switch (code) {
                case 1: return DOT1DBASETYPE_UNKNOWN; case 2: return DOT1DBASETYPE_TRANSPARENT_ONLY;
                case 3: return DOT1DBASETYPE_SOURCEROUTE_ONLY; case 4: return DOT1DBASETYPE_SRT;
                default: throw new IllegalArgumentException("Cannot create Dot1dBaseType from code " + code);
            }
        }
    }
