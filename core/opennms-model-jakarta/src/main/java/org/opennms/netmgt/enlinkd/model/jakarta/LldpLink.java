...
import org.opennms.netmgt.enlinkd.model.jakarta.converter.LldpChassisIdSubTypeConverter;
import org.opennms.netmgt.enlinkd.model.jakarta.converter.LldpPortIdSubTypeConverter;
...
public class LldpLink implements Serializable {
    ...
    @Convert(converter = LldpPortIdSubTypeConverter.class)
    ...
    public void setLldpRemChassisIdSubType(LldpChassisIdSubType lldpRemChassisIdSubType) {
