...
import org.opennms.netmgt.enlinkd.model.converter.IsisISAdjNeighSysTypeConverter;
import org.opennms.netmgt.enlinkd.model.converter.IsisISAdjStateConverter;
...
public class IsIsLink implements Serializable {
    ...
    public enum IsisISAdjState {
        ...
        IsisISAdjState(int value) { m_value = value; }
        protected static final Map<Integer, String> s_typeMap = new HashMap<>();
        static { s_typeMap.put(1, "down"); s_typeMap.put(2, "initializing"); s_typeMap.put(3, "up"); s_typeMap.put(4, "failed"); }
        public static String getTypeString(Integer code) {
            if (s_typeMap.containsKey(code)) return s_typeMap.get(code);
            return null;
        }
        public static IsisISAdjState get(Integer code) {
            if (code == null) throw new IllegalArgumentException("Cannot create IsisISAdjState from null code");
            switch (code) {
                case 1: return down; case 2: return initializing; case 3: return up; case 4: return failed;
                default: throw new IllegalArgumentException("Cannot create IsisISAdjState from code " + code);
            }
        }
    ...
    public enum IsisISAdjNeighSysType {
        ...
        private final int m_value;
        IsisISAdjNeighSysType(int value) { m_value = value; }
        protected static final Map<Integer, String> s_typeMap = new HashMap<>();
        static { s_typeMap.put(1, "l1_IntermediateSystem"); s_typeMap.put(2, "l2IntermediateSystem"); s_typeMap.put(3, "l1L2IntermediateSystem"); s_typeMap.put(4, "unknown"); }
        public static String getTypeString(Integer code) {
            if (s_typeMap.containsKey(code)) return s_typeMap.get(code);
            return null;
        }
        public static IsisISAdjNeighSysType get(Integer code) {
            if (code == null) throw new IllegalArgumentException("Cannot create IsisISAdjNeighSysType from null code");
            switch (code) {
                case 1: return l1_IntermediateSystem; case 2: return l2IntermediateSystem;
                case 3: return l1L2IntermediateSystem; case 4: return unknown;
                default: throw new IllegalArgumentException("Cannot create IsisISAdjNeighSysType from code " + code);
            }
        }
        public Integer getValue() { return m_value; }
    }
